...
import { createShortUrl } from '@/app/actions/shortUrlActions';
    ...
    return (
        ...
        <div className='w-full h-full flex flex-col items-center justify-center px-4 py-8'>
            <div className="text-center mb-12">
                <span className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 gradient-text">Shorten Your Links</span>
